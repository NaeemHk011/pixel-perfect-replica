          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-[1.4fr_auto] gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-cream/65 max-w-xl text-sm leading-relaxed">
                Whether you're seeking therapy, psychiatric care, peptide optimization, or executive coaching      we're here from the first conversation onward. No pressure. Just care.
              </p>
            ...
            <div className="flex flex-col items-start lg:items-end gap-4">
              <Link
                to="/booking"
                className="inline-flex items-center gap-2 bg-gold2 hover:bg-gold3 text-dark font-medium px-8 py-3.5 rounded-full text-sm transition-all duration-200 hover:-translate-y-0.5 shadow-[0_12px_30px_-12px_rgba(207,168,78,0.6)]"
              >
