        ...
        <div className="relative grid grid-cols-1 md:grid-cols-4 gap-5">
          ...
          {steps.map(({ number, icon: Icon, title, description }, i) => (
            <div
              ...
              className="reveal group relative bg-white rounded-2xl p-6 border border-black/8 hover:border-gold/40 hover:-translate-y-1 transition-all duration-300 hover:shadow-[0_16px_40px_-16px_rgba(184,144,64,0.18)] overflow-hidden"
            >
